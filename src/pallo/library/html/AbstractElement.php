...
abstract class AbstractElement implements Element {
     ...
     * @param string $class
     * @return null
     * @throws pallo\ZiboException when the provided style class is empty
     */
     ...
     * @param string $class
     * @return null
     * @throws pallo\ZiboException when the provided style class is empty or not a string
     */
     ...
     * @return null
     * @throws pallo\ZiboException when the name of attribute is empty or not a string
     */
