...
use pallo\library\html\table\decorator\ColumnDecorator;
...
class ArrayTable extends Table {
     ...
     * @return null
     * @throws pallo\library\html\exception\TableException when trying to set
     * the header manually
     * @see addDecorator
     */
     ...
     * @return null
     * @throws pallo\library\html\exception\TableException when trying to add a
     * row manually
     */
