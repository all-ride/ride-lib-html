...
use pallo\library\html\exception\TableNotProcessedException;
...
class FormTable extends ArrayTable implements ExportTable, Component {
     ...
     * @param string|array|pallo\library\Callback $callback Callback to the
     * action
     * @param string $confirmationMessage Message for a confirmation dialog
     * before performing the action
     * @return null
     * @throws pallo\library\html\exception\TableException when the provided
     ...
     * @return null
     * @throws pallo\library\html\exception\TableException when the search is
     ...
     * @return null
     * @throws pallo\library\html\exception\TableException when an invalid order
     ...
     * @return null
     * @throws pallo\library\html\exception\TableException when an a negative
     ...
     * @return null
     * @throws pallo\library\html\exception\TableException when no pagination is
     * set
     * @throws pallo\library\html\exception\TableException when the provided
     ...
     * @param pallo\library\html\table\decorator\Decorator $groupDecorator
     ...
     * @param pallo\library\html\table\export\ExportFormat $export Format of
     * the export
     * @return null
     */
     ...
     * @param pallo\library\html\table\export\ExportView $exportView View of
     * the export
